...
const RecentCar = ({ car }) => {
  ...
  return (
    <div className="bg-gray-200 text-white p-3 rounded-lg shadow-lg max-w-sm transform hover:scale-105 hover:shadow-2xl transition-transform duration-300">
      {/* Car Image */}
      <div className="mb-4">
        <img
          src={car_image}
      ...
      {/* Car Details */}
      <h2 className="text-lg text-black font-semibold">{model}</h2>
